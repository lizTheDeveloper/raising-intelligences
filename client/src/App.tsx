...
const TAGLINES = [
  ...
  "they asked if you love them more than wifi.",
  "they will find that one thing you thought you hid.",
  "someone is about to negotiate like a hostage situation.",
  "they asked why your face looks like that when you're thinking.",
  "they will cry because you looked at them wrong.",
  "they have developed a strong position on something you've never thought about.",
  "they asked if you can still remember what your favorite toy was.",
  "they will ask the same question until you answer correctly.",
  "they're timing you. you don't know what for.",
  "they asked if you ever had a best friend and you could tell you got it wrong.",
  "they will ask you to explain something you thought you already explained.",
  "they have decided that you owe them. they're not wrong.",
  "they asked why you don't play like their friend's parent.",
  "they will tell you everything they did today except the part that matters.",
  "they asked if you've ever been afraid of the dark and waited for your answer.",
  "they will cry because something you said didn't match what you did.",
  "they asked why adults forget to have fun.",
  "they have developed opinions about politics and you didn't even notice when.",
  "they will tell you a secret and then ask if you'll keep it.",
  "they asked why your laugh sounds different when you're on the phone.",
  "they will ask you to promise something and then test it.",
  "they asked if you ever had a phase like theirs and then judged your answer.",
  "they have decided that your house rules are unfair compared to their friend's.",
  "they will ask you to explain why something works and then ask why about every part.",
  "they asked if you remember their first word and you clearly forgot.",
  "they will tell you that their friend's parent lets them do something and waits.",
  "they asked why people say 'because I said so' when it's never a good reason.",
